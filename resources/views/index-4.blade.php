...
<body class="boxed_wrapper">
    ...
    <header class="main-header style-two style-four">
            ...
            <div class="auto-container">
                <div class="top-inner clearfix">
                    ...
                    <ul class="top-right pull-right">
                        ...
                        <li><a href="index-4">Book Appointment</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                    <div class="logo-box pull-left">
                        <figure class="logo"><a href="index"><img src="assets/images/logo-3.png" alt=""></a></figure>
                    </div>
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="current dropdown"><a href="index-4">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="index-4">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="dropdown"><a href="index-4">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="index-4">Team</a>
                                        <ul>
                                            <li><a href="team">Expert Team</a></li>
                                            <li><a href="team-details">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="index-4">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="index-4">Blog</a>
                                        <ul>
        ...
        <div class="sticky-header">
            <div class="auto-container">
                <div class="outer-box clearfix">
                    <div class="logo-box pull-left">
                        <figure class="logo"><a href="index"><img src="assets/images/small-logo-2.png" alt=""></a></figure>
                    </div>
                    <div class="menu-area pull-right">
    ...
    <!-- banner-style-four -->
    <section class="banner-style-four" style="background-image: url(assets/images/banner/banner-7.jpg);">
        <div class="auto-container">
            <div class="row align-items-center clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content-box">
                        <h2>Your Health Relies on</h2>
                        <h1>LosAlamos</h1>
                        <p>Qualified Staff With Expertise in Services We Offer for more Resonable cost with love, Just explore about More!</p>
                        <a href="index-4">Read More</a>
                    </div>
                </div>
    ...
    <section class="service-style-four">
        <div class="auto-container">
            <div class="upper-box clearfix">
                ...
                <div class="btn-box pull-right"><a href="/service" class="theme-btn style-one">All Services</a></div>
            </div>
            <div class="row clearfix">
    ...
    <!-- working-process -->
    <section class="working-process centred bg-color-1">
        <div class="auto-container">
            <div class="sec-title">
                <p>Way We Work</p>
                    ...
                    <div class="working-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="icon-holder">
                                <div class="icon-box">
                                    <i class="flaticon-flask-4"></i>
                                    <span class="count">01</span>
                                </div>
                            </div>
                            <div class="lower-content">
                                <h3>Data Collection</h3>
                                <p>For the accurate diagnoses, Perfect information is must required</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 working-block">
                    <div class="working-block-one wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="icon-holder">
                                <div class="icon-box">
                                    <i class="flaticon-microscope-1"></i>
                                    <span class="count">02</span>
                                </div>
                            </div>
                            <div class="lower-content">
                                <h3>Diagnose Process</h3>
    ...
    <section class="team-section">
        <div class="auto-container">
            <div class="sec-title">
                <p>Exploring Anatomy & Physiology</p>
                <h2>Experts For Laboratory</h2>
                <span class="separator"></span>
            </div>
            <div class="row clearfix">
    ...
    <!-- video-section -->
    <section class="video-section centred" style="background-image: url(assets/images/background/video-2.jpg);">
        <div class="auto-container">
            <div class="inner-box">
                ...
                <h1>We Ensure Safe Diagnoses & <br />Effective Therapies</h1>
                <p>We Employ The Latest Technology</p>
                <div class="link"><a href="index-4" class="theme-btn style-two">Appointment</a></div>
            </div>
        </div>
    </section>
    <!-- video-section end -->
                            ...
                            <div class="news-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="inner">
                                        <ul class="post-info clearfix">
                                            <li><i class="fas fa-comments"></i><a href="blog-details">Comments 47</a></li>
                                            <li><i class="far fa-calendar-alt"></i>Jan 12, 2020</li>
                                        </ul>
                                        <h3><a href="blog-details">Learn: Blood bank operation and management</a></h3>
                                        <p>We provide complete process piping capabilities for industrial from pulp and paper.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="content_block_06">
                            <div class="content-box">
                                <div class="sec-title left">
                                    ...
                                    <h2>We Are The Trusted Experts Lab</h2>
                                    <span class="separator"></span>
                                </div>
                                <ul class="accordion-box">
                                    <li class="accordion block">
                                        <div class="acc-btn">
                                            ...
                                            <h6>Is fasting required for UEC blood test?</h6>
                                        </div>
                                        <div class="acc-content">
                                            <div class="content">
                                                <p>That's why a fasting blood test usually requires that you avoid all food and drinks except water for 12 hours before your screening. It's also advised that you avoid alcohol for 24 hours before your fasting blood test, as well as any strenuous exercise.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="accordion block active-block">
                                        <div class="acc-btn active">
                                            <div class="icon-outer"><i class="fas fa-plus"></i></div>
                                            <h6>Can you exercise before a non fasting blood test?</h6>
                                        </div>
                                    ...
                                    <li class="accordion block">
                                         <div class="acc-btn">
                                            <div class="icon-outer"><i class="fas fa-plus"></i></div>
                                            <h6>How long do blood test results take to get back?</h6>
                                        </div>
                                        <div class="acc-content">
                                            <div class="content">
                                                <p>That's why a fasting blood test usually requires that you avoid all food and drinks except water for 12 hours before your screening. It's also advised that you avoid alcohol for 24 hours before your fasting blood test, as well as any strenuous exercise.</p>
                                    ...
                                    <li class="accordion block">
                                         <div class="acc-btn">
                                            <div class="icon-outer"><i class="fas fa-plus"></i></div>
                                            <h6>How long does a pathology request last?</h6>
                                        </div>
                                        <div class="acc-content">
                                            <div class="content">
                                                <p>That's why a fasting blood test usually requires that you avoid all food and drinks except water for 12 hours before your screening. It's also advised that you avoid alcohol for 24 hours before your fasting blood test, as well as any strenuous exercise.</p>
