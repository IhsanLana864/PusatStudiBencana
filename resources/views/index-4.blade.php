            ...
            <div class="auto-container">
                <div class="top-inner clearfix">
                    ...
                    <ul class="top-right pull-right">
                        ...
                        <li><a href="index-4.html">Book Appointment</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <ul class="navigation clearfix">
                                    <li class="current dropdown"><a href="index-4.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="index-4.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="dropdown"><a href="index-4.html">Team</a>
                                        <ul>
            ...
            <div class="row align-items-center clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content-box">
                        ...
                        <a href="index-4.html">Read More</a>
                    </div>
                </div>
    ...
    <section class="service-style-four">
        <div class="auto-container">
            <div class="upper-box clearfix">
                ...
                <div class="btn-box pull-right"><a href="service.html" class="theme-btn style-one">All Services</a></div>
            </div>
            <div class="row clearfix">
    ...
    <section class="video-section centred" style="background-image: url(assets/images/background/video-2.jpg);">
        <div class="auto-container">
            <div class="inner-box">
                ...
                <div class="link"><a href="index-4.html" class="theme-btn style-two">Appointment</a></div>
            </div>
        </div>
    </section>
    <!-- video-section end -->
