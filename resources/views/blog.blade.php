            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                                ...
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="blog.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="blog.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="dropdown"><a href="blog.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="blog.html">Elements</a>
                                        <div class="megamenu">
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="blog.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="our-blog-content">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <ul class="post-info clearfix">
                                        <li><i class="fas fa-comments"></i><a href="blog.html">Comments 47</a></li>
                                    ...
                                    <div class="btn-box"><a href="blog-details.html" class="theme-btn style-one">READ MORE</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="news-block-three">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <ul class="post-info clearfix">
                                        <li><i class="fas fa-comments"></i><a href="blog.html">Comments 30</a></li>
                        ...
                        <div class="news-block-three">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <h3><a href="blog-details.html">Learn: Blood Bank Operations & Management</a></h3>
                                    <p>We provide complete process piping capabilities for industrial from paper. Laboratories used for scientific research take many forms because of the differing requirements of specialists.</p>
                                    <div class="btn-box"><a href="blog-details.html" class="theme-btn style-one">READ MORE</a></div>
                                </div>
                            </div>
                        ...
                        <div class="news-block-three">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <ul class="post-info clearfix">
                                        <li><i class="fas fa-comments"></i><a href="blog.html">Comments 45</a></li>
                                        <li><i class="fas fa-calendar-alt"></i>July 25, 2019</li>
                                        <li><i class="fas fa-user"></i><a href="blog.html">By Admin</a></li>
                                    </ul>
                                    <h3><a href="blog-details.html">Behind the Scenes of Clinical Research Procedures</a></h3>
                                    <p>We provide complete process piping capabilities for industrial from paper. Laboratories used for scientific research take many forms because of the differing requirements of specialists.</p>
                                    <div class="btn-box"><a href="blog-details.html" class="theme-btn style-one">READ MORE</a></div>
                                </div>
                            </div>
                        ...
                        <div class="pagination-wrapper centred">
                            <ul class="pagination clearfix">
                                <li class="prev-btn"><a href="blog.html"><i class="fas fa-long-arrow-alt-left"></i>&nbsp;&nbsp;PREV</a></li>
                                <li><a href="blog.html">1</a></li>
                                <li><a href="blog.html">2</a></li>
                                <li><a href="blog.html" class="active">3</a></li>
                                <li><a href="blog.html">4</a></li>
                                <li><a href="blog.html">5</a></li>
                                <li class="next-btn"><a href="blog.html">Next&nbsp;&nbsp;<i class="fas fa-long-arrow-alt-right"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
