            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                                ...
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="contact.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="contact.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="dropdown"><a href="contact.html">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="contact.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="contact.html">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="contact.html">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="contact.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
