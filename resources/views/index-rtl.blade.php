...
<body class="boxed_wrapper">
    ...
    <div id="search-popup" class="search-popup home-rtl">
        <div class="close-search"><span>قريب</span></div>
    ...
    <!-- main header -->
    <header class="main-header style-two home-rtl">
                        ...
                        <div class="header-info">
                            <ul>
                                ...
                                <li>
                                    <div class="title">
                                        <h5>ساعات العمل</h5>
                                        <span>من 8:00 صباحًا إلى 6:00 مساءً</span>
                                    </div>
                                ...
                                <li>
                                    <div class="title">
                                        <h5>عنوان</h5>
                                        <span>E44 ، شارع التصميم ، ركن الويب ملبورن.</span>
                                    </div>
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            ...
            <div class="contact-info text-right">
                ...
                <ul>
                    <li>شيكاغو 12 ، ميلبورن سيتي ، الولايات المتحدة الأمريكية</li>
    ...
    <!-- banner-style-two -->
    <section class="banner-style-two home-rtl">
    ...
    <!-- about-style-two -->
    <section class="about-style-two home-rtl">
                    ...
                    <div id="content_block_05">
                        <div class="content-box">
                            <div class="sec-title left">
                                <p>ماذا عنا</p>
                                <h2>تقديم مجموعة واسعة من خدمات التشخيص.</h2>
                                <span class="separator"></span>
                            </div>
                            <div class="text">
                                <p>يجذب مجال الرعاية الصحية المسعف لإنقاذ الأرواح ومساعدة الناس ، كونك طبيبًا ليس هو خيارك الوحيد. كيف يمكننا أن نساعد المرضى دون أن تكون طبيباً ، وهنا نقدم فرصة رائعة.</p>
                                <p>مجهزة ومدربة للعمل في المستشفيات ومختبرات التشخيص والرعاية الصحية. NABL هو مجتمع مستقل يوفر الاعتراف بالتقنية.</p>
                            </div>
    ...
    <section class="service-style-two bg-color-1 centred">
        ...
        <div class="auto-container">
            <div class="sec-title">
                <p>ماذا نفعل الان</p>
                <h2>استكشاف الخدمات الرئيسية</h2>
                <span class="separator"></span>
            </div>
            <div class="row clearfix">
    ...
    <!-- team-section -->
    <section class="team-section home-rtl">
        <div class="auto-container">
            <div class="sec-title">
                <p>استكشاف علم التشريح وعلم وظائف الأعضاء</p>
                <h2>الخبراء للمختبر</h2>
                <span class="separator"></span>
            </div>
            <div class="row clearfix">
    ...
    <!-- faq-section -->
    <section class="faq-section home-rtl">
                            ...
                            <ul class="accordion-box">
                                <li class="accordion block">
                                    <div class="acc-btn">
                                        ...
                                        <h6>هل الصيام مطلوب لفحص الدم في UEC؟</h6>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content">
                                            <p>لهذا السبب يتطلب فحص دم الصيام عادة تجنب جميع الأطعمة والمشروبات باستثناء الماء لمدة 12 ساعة قبل الفحص. يُنصح أيضًا بتجنب تناول الكحول لمدة 24 ساعة قبل فحص دمك الصائم وأيضًا ممارسة التمارين الرياضية الشاقة.</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="accordion block active-block">
                                    <div class="acc-btn active">
                                        <div class="icon-outer"><i class="fas fa-plus"></i></div>
                                        <h6>يمكنك ممارسة قبل اختبار الدم غير الصيام؟</h6>
                                    </div>
                                ...
                                <li class="accordion block">
                                     <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-plus"></i></div>
                                        <h6>ما المدة التي تستغرقها نتائج فحص الدم للعودة؟</h6>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content">
                                            <p>لهذا السبب يتطلب فحص دم الصيام عادة تجنب جميع الأطعمة والمشروبات باستثناء الماء لمدة 12 ساعة قبل الفحص. يُنصح أيضًا بتجنب تناول الكحول لمدة 24 ساعة قبل فحص دمك الصائم وأيضًا ممارسة التمارين الرياضية الشاقة.</p>
                                ...
                                <li class="accordion block">
                                     <div class="acc-btn">
                                        <div class="icon-outer"><i class="fas fa-plus"></i></div>
                                        <h6>ما المدة التي يستغرقها طلب علم الأمراض؟</h6>
                                    </div>
                                    <div class="acc-content">
                                        <div class="content">
                                            <p>لهذا السبب يتطلب فحص دم الصيام عادة تجنب جميع الأطعمة والمشروبات باستثناء الماء لمدة 12 ساعة قبل الفحص. يُنصح أيضًا بتجنب تناول الكحول لمدة 24 ساعة قبل فحص دمك الصائم وأيضًا ممارسة التمارين الرياضية الشاقة.</p>
                    ...
                    <div class="testimonial-content">
                        <div class="inner-box">
                            <div class="upper-box">
                                ...
                                <div class="text">
                                    <p>من خلال مجموعة المهارات والمعرفة وأخلاقيات العمل ، يمكن أن أكون إضافة رائعة للفريق لتقديم أفضل نتيجة.</p>
                                </div>
                            </div>
                            <div class="author-info">
                                <h4>ماريا مولاس</h4>
                                <span class="designation">مدير تسويق</span>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-content">
                        <div class="inner-box">
                            ...
                            <div class="author-info">
                                <h4>فيكتوريا بورتر</h4>
                                <span class="designation">المدير التنفيذي</span>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-content">
                        <div class="inner-box">
                            ...
                            <div class="author-info">
                                <h4>ميلتون جلاسر</h4>
                                <span class="designation">مساعد مدير</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- news-style-two -->
    <section class="news-style-two home-rtl">
        <div class="auto-container">
            <div class="sec-title">
                <p>أخبارنا و مدونة</p>
                <h2>انشر ما تفكر فيه</h2>
                <span class="separator"></span>
            </div>
            <div class="row clearfix">
    ...
    <!-- newsletter-section -->
    <section class="newsletter-section home-rtl">
        <div class="auto-container">
            <div class="row clearfix">
                <div class="col-lg-5 col-md-12 col-sm-12 inner-column">
                    <div class="inner-box">
                        <h2>اشترك في النشرة الإخبارية</h2>
                        <p>ابق على اتصال معنا للحصول على آخر الأخبار وكوبونات الخصم</p>
                    </div>
                </div>
    ...
    <!-- main-footer -->
    <section class="main-footer home-rtl">
