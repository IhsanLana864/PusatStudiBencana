            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="team-details.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="team-details.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="dropdown"><a href="team-details.html">Pages</a>
                                        <ul>
                                    ...
                                    <li class="current dropdown"><a href="team-details.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="team-details.html">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="team-details.html">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="team-details.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-8 col-md-12 col-sm-12 left-column">
                    <div class="left-content">
                        <div class="upper-box">
                            <div class="title">
                                <h3>Martin Tompson</h3>
                                <p>Laboratory Technician</p>
                            </div>
                            <ul class="list-item clearfix">
                                <li><span>Expertise</span>Biotechnology <br />Vaccines, International</li>
                                <li><span>Education</span>Doctor of Medicine, University of Texas, USA (1990) <br />Medical Orientation Program, St. Louis University St. Louis, Missouri 1996)</li>
                                <li><span>Experience</span>15 years of Experience in Medicine</li>
                                <li><span>Profession</span>MD Dean and Executive Vice President for Medical Affairs School of <br />Medicine and Graduate School of Biomedical Sciences University of <br />Texas Health Science Center at San Antonio</li>
                            </ul>
                        </div>
                        <div class="lower-box">
                            ...
                            <div class="text">
                                ...
                                <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, aliquam quaerat voluptatem. Ut enim ad minima veniam,</p>
                            </div>
