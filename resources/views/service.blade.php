            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="service.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="service.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="service.html">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="service.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="service.html">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="service.html">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="service.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    ...
                                    <h3><a href="service-details.html">Healthcare Labs</a></h3>
                                    <p>Lorem ipsum dolor amet consectetur adipiscing elit sed do eiusmod tempor incididunt.</p>
                                    <div class="link"><a href="service-details.html">Read More <i class="fas fa-angle-double-right"></i></a></div>
                                </div>
                            </div>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    ...
                                    <h3><a href="service-details.html">Environmental Testing</a></h3>
                                    <p>Lorem ipsum dolor amet consectetur adipiscing elit sed do eiusmod tempor incididunt.</p>
                                    <div class="link"><a href="service-details.html">Read More <i class="fas fa-angle-double-right"></i></a></div>
                                </div>
                            </div>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    ...
                                    <h3><a href="service-details.html">Sample Preparation</a></h3>
                                    <p>Lorem ipsum dolor amet consectetur adipiscing elit sed do eiusmod tempor incididunt.</p>
                                    <div class="link"><a href="service-details.html">Read More <i class="fas fa-angle-double-right"></i></a></div>
                                </div>
                            </div>
