...
<body class="boxed_wrapper">
            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="research.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="research.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="research.html">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="research.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="research.html">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="research.html">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="research.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- project-section -->
    <section class="project-section research-page centred">
        <div class="auto-container">
            <div class="row clearfix">
                    ...
                    <div class="project-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="content-box">
                                <h3><a href="research-details.html">PATHOLOGY</a></h3>
            ...
            <div class="more-btn"><a href="resource.html" class="theme-btn style-one">View More</a></div>
        </div>
    </section>
    <!-- project-section end -->
