                    ...
                    <div class="blog-details-content">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
                                    </div>
                                    ...
                                    <div class="text">
                                        <p>totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-box">
                                <div class="comment">
                                    <figure class="author-thumb"><img src="assets/images/news/comment-1.jpg" alt=""></figure>
                                    <div class="comment-inner">
                                        <div class="comment-info">
                                            <h4>Jannatul Fa.</h4>
                                            <span class="date">15 April, 2019 At 8:30am</span>
                                        </div>
                                        <div class="text">
                                ...
                                <div class="comment replay-comment">
                                    <figure class="author-thumb"><img src="assets/images/news/comment-2.jpg" alt=""></figure>
                                    <div class="comment-inner">
                                        <div class="comment-info">
                                            <h4>Daniel Vandaft</h4>
                                            <span class="date">16 April, 2019 At 8:30am</span>
                                        </div>
                                        <div class="text">
                                ...
                                <div class="comment">
                                    <figure class="author-thumb"><img src="assets/images/news/comment-3.jpg" alt=""></figure>
                                    <div class="comment-inner">
                                        <div class="comment-info">
                                            <h4>James Muler</h4>
                                            <span class="date">14 April, 2019 At 8:30am</span>
                                        </div>
                                        <div class="text">
                            ...
                            <form method="post" action="sendemail.php" id="contact-form" class="comment-form"> 
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                        <button type="submit" class="theme-btn style-one" name="submit-form">Post Comment</button>
                                    </div>
                                </div>
                            </form>
                        </div>
