            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                                ...
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="counter-element-2.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="counter-element-2.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="dropdown"><a href="counter-element-2.html">Team</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="counter-element-2.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
