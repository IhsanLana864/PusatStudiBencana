            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="research-details">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="research-details">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="research-details">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="research-details">Team</a>
                                        <ul>
                                            <li><a href="team">Expert Team</a></li>
                                            <li><a href="team-details">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="research-details">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="research-details">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="research-details" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="research-details-content">
                ...
                <div class="lower-box clearfix">
                    <ul class="social-links clearfix">
                        ...
                        <li><a href="research-details"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="research-details"><i class="fab fa-twitter"></i></a></li>
                        <li><a href="research-details"><i class="fab fa-linkedin-in"></i></a></li>
                        <li><a href="research-details"><i class="fab fa-pinterest-p"></i></a></li>
                        <li><a href="research-details"><i class="fab fa-google-plus-g"></i></a></li>
                    </ul>
                    <div class="next-btn"><a href="research-details" class="theme-btn style-one">NEXT&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i></a></div>
                </div>
            </div>
        </div>
    </section>
