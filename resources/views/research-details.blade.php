            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="research-details.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="research-details.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="research-details.html">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="research-details.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="research-details.html">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="research-details.html">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="research-details.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="research-details"> 
        <div class="auto-container">
            <div class="research-details-content">
                <div class="upper-box">
                    <figure class="image-box"><a href="assets/images/gallery/project-10.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/project-10.jpg" alt=""></a></figure>
                    <ul class="info-list clearfix">
                        ...
                        <li>
                            <div class="box">
                                <div class="icon-box"><i class="flaticon-marker-1"></i></div>
                                <h4>Location</h4>
                        ...
                        <li>
                            <div class="box">
                                <div class="icon-box"><i class="flaticon-report-1"></i></div>
                                <h4>Category</h4>
                                <p>Automation, Equipment</p>
                            </div>
                        </li>
                    </ul>
                    <h3>Common Physics Laboratory Apparatus</h3>
                    <p>The equipment found in physics laboratories varies in relation to the focus of research. Apparatus in physics laboratories may range from simple balances to lasers and specialized semiconductor instruments. Computational analysis, and therefore computation equipment, has also become essential to physics research. Physics laboratory apparatus aid in determining measurements, calibration, physical property variations and precision.</p>
                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 text-column">
                            <div class="text">
                                <div class="single-item">
                                    <h3>General Laboratory Equipment</h3>
                                    <p>The most basic physics laboratory equipment includes fume hoods, desks, tables, benches and gas, water and vacuum lines. Safety equipment may include gloves, goggles and eyewash stations.</p>
                                </div>
                                <div class="single-item">
                                    <h3>Analyzer Instruments</h3>
                                    <p>Numerous instruments perform analysis on samples in physics laboratories. Some examples include impedance analyzers, particle analyzers, optical multichannel analyzers, semiconductor parameter analyzers, spectrum analyzers, capacitance-voltage (CV) analyzers, and X-ray diffractometers for characterizing crystalline materials and identifying phases.</p>
                                </div>
                                <div class="single-item">
                                    <h3>Atomic Physics Equipment</h3>
                                    <p>Atomic physics laboratories contain unique apparatus. These may include saturation absorption spectroscopy, RF optical pumping and pulsed NMR.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                            <figure class="image-box"><img src="assets/images/gallery/project-11.jpg" alt=""></figure>
                        </div>
                    </div>
                </div>
                <div class="lower-box clearfix">
                    <ul class="social-links clearfix">
                        <li><h3>Sheare Now:</h3></li>
                        <li><a href="research-details.html"><i class="fab fa-facebook-f"></i></a></li>
                        <li><a href="research-details.html"><i class="fab fa-twitter"></i></a></li>
                        <li><a href="research-details.html"><i class="fab fa-linkedin-in"></i></a></li>
                        <li><a href="research-details.html"><i class="fab fa-pinterest-p"></i></a></li>
                        <li><a href="research-details.html"><i class="fab fa-google-plus-g"></i></a></li>
                    </ul>
                    <div class="next-btn"><a href="research-details.html" class="theme-btn style-one">NEXT&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i></a></div>
                </div>
            </div>
        </div>
    </section>
