            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="service-element-1">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="service-element-1">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="dropdown"><a href="service-element-1">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="service-element-1">Team</a>
                                        <ul>
                                            <li><a href="team">Expert Team</a></li>
                                            <li><a href="team-details">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="current dropdown"><a href="service-element-1">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="service-element-1">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="service-element-1" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
