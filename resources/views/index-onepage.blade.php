...
<body class="boxed_wrapper">
    ...
    <!-- service-section -->
    <section class="service-section bg-color-1 centred" id="service">
    ...
    <!-- testimonial-section -->
    <section class="testimonial-section centred" id="testimonial">
        <div class="auto-container">
            <div class="sec-title">
                <p>Testimonial</p>
    ...
    <!-- news-section -->
    <section class="news-section bg-color-1" id="blog">
        <div class="auto-container">
            <div class="sec-title">
                <p>OUR NEWS & BLOG</p>
