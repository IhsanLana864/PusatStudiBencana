                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="service-details.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="service-details.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="service-details.html">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="service-details.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="service-details.html">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="service-details.html">Blog</a>
                                        <ul>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 sidebar-side">
                    <div class="service-sidebar">
                        <ul class="categories-list clearfix">
                            ...
                            <li><a href="service-details.html" class="active">Pathology Testing</a></li>
                            <li><a href="service-details.html">Sample Preparation</a></li>
                            <li><a href="service-details.html">Healthcare Labs</a></li>
                            <li><a href="service-details.html">Advanced Microscopy</a></li>
                            <li><a href="service-details.html">Advanced Robotics</a></li>
                            <li><a href="service-details.html">Environmental Testing</a></li>
                            <li><a href="service-details.html">Anatomical Pathology</a></li>
                        </ul>
                        <div class="need-help">
                            <h3>Need Help?</h3>
