            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                                ...
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="team.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="team.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="team.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="team.html">Elements</a>
                                        <div class="megamenu">
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="team.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
