            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="team">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="team">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="team">Team</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="team">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="team" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
