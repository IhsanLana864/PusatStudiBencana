            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="books">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="books">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="books">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="books">Team</a>
                                        <ul>
                                            <li><a href="team">Expert Team</a></li>
                                            <li><a href="team-details">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="books">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="books">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="books" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            <figure class="image-box"><a href="assets/images/resource/book-1.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/resource/book-1.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="books">A Crack in Creation</a></h3>
                                <p>Gene Editing and the Unthinkable Power to Control Evolution</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            <figure class="image-box"><a href="assets/images/resource/book-2.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/resource/book-2.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="books">Number Theory</a></h3>
                                <p>Autophagy differentially regulates TNF receptor Fn14 by distinct mammalian Atg8 proteins</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            <figure class="image-box"><a href="assets/images/resource/book-3.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/resource/book-3.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="books">The Vital Question</a></h3>
                                <p>Energy, Evolution, and the Origins of Complex Life</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            ...
                            <div class="lower-content">
                                <h3><a href="books">I Contain Multitudes</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            ...
                            <div class="lower-content">
                                <h3><a href="books">Mitochondria & the Future of Medicine</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            ...
                            <div class="lower-content">
                                <h3><a href="books">This Is Your Brain on Parasites</a></h3>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            ...
                            <div class="lower-content">
                                <h3><a href="books">The Epigenetics Revolution</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            ...
                            <div class="lower-content">
                                <h3><a href="books">Loose Leaf Benson's Microbiological Application</a></h3>
