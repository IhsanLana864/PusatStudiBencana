            ...
            <div class="auto-container">
                <div class="outer-box clearfix">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class="dropdown"><a href="books.html">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="books.html">Header Style</a>
                                                <ul>
                                    ...
                                    <li class="current dropdown"><a href="books.html">Pages</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="books.html">Team</a>
                                        <ul>
                                            <li><a href="team.html">Expert Team</a></li>
                                            <li><a href="team-details.html">Team Details</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="books.html">Elements</a>
                                        <div class="megamenu">
                                    ...
                                    <li class="dropdown"><a href="books.html">Blog</a>
                                        <ul>
                    ...
                    <div class="menu-right-content pull-right clearfix">
                        ...
                        <div class="btn-box"><a href="books.html" class="theme-btn style-two">Book Appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            ...
                            <div class="lower-content">
                                <h3><a href="books.html">A Crack in Creation</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            ...
                            <div class="lower-content">
                                <h3><a href="books.html">Number Theory</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 single-block">
                        <div class="single-book-content">
                            ...
                            <div class="lower-content">
                                <h3><a href="books.html">The Vital Question</a></h3>
