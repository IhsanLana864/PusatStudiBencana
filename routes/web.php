...
Route::get('/about-element-2', function () {
    return view('about-element-2');
});
Route::get('/about-element-3', function () {
    return view('about-element-3');
});
Route::get('/about-element-4', function () {
    return view('about-element-4');
});
...
Route::get('/counter-element-2', function () {
    return view('counter-element-2');
});
Route::get('/counter-element-3', function () {
    return view('counter-element-3');
});
Route::get('/counter-element-4', function () {
    return view('counter-element-4');
});
Route::get('/appointment-element', function () {
    return view('appointment-element');
});
...
Route::get('/index-onepage', function () {
    return view('index-onepage');
});
...
Route::get('/intro-element-2.', function () {
    return view('intro-element-2');
});
Route::get('/news-element-1', function () {
    return view('news-element-1');
});
Route::get('/news-element-2', function () {
    return view('news-element-2');
});
Route::get('/news-element-3', function () {
    return view('news-element-3');
});
